...
export declare function Collapsible({ id, expandOnPrint, open, transition, preventMeasuringOnChildrenUpdate: _preventMeasuringOnChildrenUpdate, children, onAnimationEnd, }: CollapsibleProps): JSX.Element;
export {};
