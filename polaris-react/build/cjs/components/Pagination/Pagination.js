...
function Pagination({
  ...
  const labelTextMarkup = hasNext && hasPrevious ? /*#__PURE__*/React__default["default"].createElement(Text.Text, {
    variant: "bodyMd",
    as: "span"
  }, label) : /*#__PURE__*/React__default["default"].createElement(Text.Text, {
    variant: "bodyMd",
    color: "subdued",
    as: "span"
  }, label);
