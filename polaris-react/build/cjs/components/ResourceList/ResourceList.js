...
const ResourceList = function ResourceList({
  ...
  const bulkActionsMarkup = isSelectable && selectMode ? /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  const resourceListWrapperClasses = css.classNames(ResourceList$1["default"].ResourceListWrapper, Boolean(bulkActionsMarkup) && selectMode && ResourceList$1["default"].ResourceListWrapperWithBulkActions);
