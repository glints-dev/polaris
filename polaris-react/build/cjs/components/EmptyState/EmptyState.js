...
function EmptyState({
  ...
  const footerContentMarkup = footerContent ? /*#__PURE__*/React__default["default"].createElement(Box.Box, {
    paddingBlockStart: "4"
  ...
  const headingMarkup = heading ? /*#__PURE__*/React__default["default"].createElement(Text.Text, {
    variant: headingSize,
    as: "p"
  }, heading) : null;
