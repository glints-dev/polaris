...
import { createSassMigrator, namespace, isNumericOperator, isTransformableLength, toTransformablePx, isSassFunction, getFunctionArgs, StopWalkingFunctionNodes } from '../../utilities/sass.mjs';
import { isKeyOf } from '../../utilities/type-guards.mjs';

var stylesTokenizeSpace = createSassMigrator('styles-tokenize-space', (_, {
  methods,
  options
}, context) => {
...
export { stylesTokenizeSpace as default };
