...
import { createInlineComment, namespace, isNumericOperator, isTransformableLength, isUnitlessZero, isSassFunction, getFunctionArgs, toTransformablePx, StopWalkingFunctionNodes } from '../../utilities/sass.mjs';
      ...
      function handleFontSize() {
        parsedValue.walk(node => {
          ...
          if (node.type === 'word') {
            ...
            const fontSizeInPx = isUnitlessZero(dimension) ? `${dimension.number}px` : toPx(`${dimension.number}${dimension.unit}`);
...
export { stylesTokenizeFont as default };
