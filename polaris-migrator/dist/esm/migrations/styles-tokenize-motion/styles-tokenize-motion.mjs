...
import { createSassMigrator, hasNumericOperator, isPolarisVar, isSassVariable, setNodeValue, isTransformableDuration } from '../../utilities/sass.mjs';
...
var stylesTokenizeMotion = createSassMigrator('replace-sass-transition', (_, {
  methods
}, context) => {
...
export { stylesTokenizeMotion as default };
